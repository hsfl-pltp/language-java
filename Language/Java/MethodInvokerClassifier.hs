...
instance AnalyzedTransformer Exp where
  ...
  transformToAnalyzed scope (PrePlus expr) = PrePlus (transformToAnalyzed scope expr)
  transformToAnalyzed scope (PreMinus expr) = PreMinus (transformToAnalyzed scope expr)
  transformToAnalyzed scope (PreBitCompl expr) = PreBitCompl (transformToAnalyzed scope expr)
  transformToAnalyzed scope (PreNot expr) = PreNot (transformToAnalyzed scope expr)
